...
#[test]
fn negative_method_modifier_noexcept_mismatch() {
    assert_case("negative_method_modifier_noexcept_mismatch");
}
...
#[test]
fn negative_template_parameter_pack_mismatch() {
    assert_case("negative_template_parameter_pack_mismatch");
}
