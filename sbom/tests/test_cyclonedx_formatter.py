...
from sbom.internal.generator.cyclonedx_formatter import generate_cyclonedx, _normalize_spdx_license
...
class TestCycloneDXFormatter(unittest.TestCase):
    ...
    def test_generate_cyclonedx_cratesio_external_ref_from_source_field(self):
        ...
        self.assertIsNotNone(dist_ref, "Expected distribution externalReference for crates.io crate")
...
class TestNormalizeSpdxLicenseCdx(unittest.TestCase):
    ...
    def test_lowercase_or_routes_to_expression_field(self):
        ...
        components = [{"name": "serde", "version": "1.0.228", "purl": "pkg:cargo/serde@1.0.228",
                       "type": "library", "license": "Apache-2.0 or MIT"}]
        ...
        self.assertIn("expression", licenses[0], "compound license must use 'expression' field")
