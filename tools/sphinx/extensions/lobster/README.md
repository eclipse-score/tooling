...
The extension registers a custom Sphinx builder named `lobster`. It is used
automatically by the `rules_score` Sphinx build integration.
...
The extension consists of two classes in `lobster.py`:
