...
def _component_impl(ctx):
    ...
    # Component requirement .lobster files always include `derived_from` as
    # a tracing target, including any AoU entries within it (resolved only at
    # the dependable_element level).
    #
