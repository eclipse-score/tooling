...
from test_case_coverage.compute_lock import SCHEMA_VERSION, LockFile, RequirementEntry, TestCase


def _lock(*reqs):
    return LockFile(schema_version=SCHEMA_VERSION, requirements=list(reqs))
