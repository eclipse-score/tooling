...
use crate::activity_ast::{
	ActionStmt, ArrowStmt, BackwardStmt, ControlKind, ControlStmt, ElseStmt, EndIfStmt, EndWhileStmt, ForkAgainStmt, ForkEndKind,
	ForkEndStmt,
	ForkModifier, ForkStartStmt, IfStartStmt, RepeatStartStmt, RepeatWhileStmt, StartStmt,
	StopStmt, SwimlaneStmt, WhileStartStmt,
};
...
impl PumlActivityParser {
	...
	fn parse_start_stmt(_pair: pest::iterators::Pair<Rule>) -> Result<StartStmt, ActivityParserError> {
		Ok(StartStmt)
	}

	fn parse_stop_stmt(_pair: pest::iterators::Pair<Rule>) -> Result<StopStmt, ActivityParserError> {
		Ok(StopStmt)
	}
	...
	fn parse_endif_stmt(_pair: pest::iterators::Pair<Rule>) -> Result<EndIfStmt, ActivityParserError> {
		Ok(EndIfStmt)
	}
